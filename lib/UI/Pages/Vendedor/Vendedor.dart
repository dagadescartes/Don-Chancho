...
class _VendedorState extends State<Vendedor> {
  ...
  bool isLoading = true;
  QuerySnapshot _cojines, _lechona;
    ...
    return Scaffold(
        ...
        drawer: Drawer(
          ...
          DrawerItems(
            ...
            iconos: Icons.home,
            go: () => Navigator.push(
                context, MaterialPageRoute(builder: (context) => Vendedor())),
          ),
          DrawerItems(
              text: 'Pedidos',
                              ...
                              onPressed: () async {
                                final data = await RepositoryAlterno()
                                    .revisiondepedidosporpagar(
                                        ...
                                        (context) => AdminPedidosporCancelar(data: data)));
                                        } else {
                                          return showDialog(
                        context: context,
                        builder: (context) => AlertDialog(
              ...
              go: () async {
                ...
                if (data != null) {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => OrdenesRechazadas(data: data)));
                } else {
                  return showDialog(
                      context: context,
                      builder: (context) => AlertDialog(
                            title: Text('Lo sentimos'),
                            content:
                                Text('Ahora no podemos conectar con el server'),
                          ));
                }
              }),
          DrawerItems(
              ...
              go: () async {
                ...
                if (data != null) {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => OrdenesEntregadas(data: data)));
                } else {
                  return showDialog(
                      context: context,
                      builder: (context) => AlertDialog(
                      ...
                      content: TextButton(
                          onPressed: () async {
                            ...
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) => SetPedidos(
                                        lechona: _lechona, cojines: _cojines)));
                          },
                          child: Text(
                            'Nuevo cliente',
                            style: TextStyle(fontSize: 18),
